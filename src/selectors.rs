...
pub mod location {
    ...
    define_selector!(
        leaderboard,
        __LOC_LEADERBOARD,
        r#"div[class="LeaderBoardSection"]"#
    );
}
...
pub mod target {
    ...
    define_selector!(
        checklists,
        __TGT_CHECKLISTS,
        r#"p[class="u-text-3 u-margin-none"]"#
    );
    define_selector!(
        hotspot_select,
        __TGT_HOTSPOT_SELECT,
        r#"a[href^="hotspot"]"#
    );
    define_selector!(
        native,
        __TGT_NATIVE,
        r#"section[aria-labelledby="native-and-naturalized"]"#
    );
    ...
    define_selector!(
        rows,
        __TGT_ROWS,
        r#"li[class="ResultsStats ResultsStats--action ResultsStats--toEdge"]"#
    );
    ...
    define_selector!(
        species_count,
        __TGT_SPECIES_COUNT,
        r#"strong[class="Heading Heading--h2"]"#
    );
}
